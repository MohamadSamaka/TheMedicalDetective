...
class EmailVerificationManager:
    ...
    def confirm_code(self, request):
        ...
        if request.session.session_key:
            ...
            if request.path_info == '/user/verify-code':
    ...
    def send_verification_code(self, request, sent_inputs):
        ...
        EmailVerificationManager.refresh_code()
        return HttpResponse("sent code successfully")
    
    def refresh_code():
        EmailVerificationManager.code = ''.join(str(randint(0, 9)) for _ in range(4))
